...
Not a huge change, but it does make the code a bit less repetitive. <Citation value={1} />
...
<Footnotes>
	<Footnote value={1}>
	I stole this idea from [this implementation of Lox in Chicken Scheme](https://github.com/harryposner/schlox). If you found this post interesting, you may find their code to be as well.
	</Footnote>
</Footnotes>
