...
export const metadata = {
	...
	description: "A retrospective on my experience migrating this website to React 19 and Parcel",
	date: "2025-01-05",
	tags: ["web-dev"],
};
...
<Footnotes>
	<Footnote value={1}>
	See [Dan Abramov's article](https://overreacted.io/why-does-rsc-integrate-with-a-bundler/) for more details on why using RSC requires a bundler.
	</Footnote>
	<Footnote value={2}>
