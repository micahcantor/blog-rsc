...
import { Citation, Footnote, Footnotes } from "~/src/components/Footnote.tsx";
...
In our interpreter, we represent expressions with a data type called `Expr` <Citation value={1} />:
